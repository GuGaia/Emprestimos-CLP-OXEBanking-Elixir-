defmodule Emprestimo_OXBWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Emprestimo_OXBWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Emprestimo_OXBWeb.Gettext, "errors", msg, opts)
    end
  end
